                ...
                <Card sx={{backgroundColor:"#FCF6F5"}} variant="outlined">
                    <CardContent>
                        <Stack alignItems="start" spacing={1}>
                            ...
                            <Typography variant="body1"><Link href="https://www.tricitysrilanka.com/pages/pdfs/gala_night_2015.pdf">Download Flyer</Link></Typography>
                        </Stack>
                    </CardContent>
                </Card>
                <Card sx={{backgroundColor:"#FCF6F5"}} variant="outlined">
                    <CardContent>
                        <Stack alignItems="start" spacing={1}>
                            ...
                            <Typography variant="body1"><Link href="https://www.tricitysrilanka.com/pages/pdfs/beach_trip_2015.pdf">Download Flyer</Link></Typography>
                        </Stack>
                    </CardContent>
                </Card>
                <Card sx={{backgroundColor:"#FCF6F5"}} variant="outlined">
                    <CardContent>
                        <Stack alignItems="start" spacing={1}>
                            ...
                            <Typography variant="body1"><Link href="https://www.tricitysrilanka.com/pages/pdfs/summer_event_2015.pdf">Download Flyer</Link></Typography>
                        </Stack>
                    </CardContent>
                </Card>
            </Stack>
