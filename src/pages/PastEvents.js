                ...
                <Card sx={{backgroundColor:"#FCF6F5"}} variant="outlined">
                    <CardContent>
                        <Stack alignItems="start" spacing={1}>
                            ...
                            <Typography variant="body1"><Link href={beachDay} target="_blank" rel="noreferrer">Download Flyer</Link></Typography>
                        </Stack>
                    </CardContent>
                </Card>
                <Card sx={{backgroundColor:"#FCF6F5"}} variant="outlined">
                    <CardContent>
                        <Stack alignItems="start" spacing={1}>
                            ...
                            <Typography variant="body1"><Link href={summerEvent} target="_blank" rel="noreferrer">Download Flyer</Link></Typography>
                        </Stack>
                    </CardContent>
                </Card>
            </Stack>
